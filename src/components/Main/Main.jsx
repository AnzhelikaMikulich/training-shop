      ...
      <div class="container">
        ...
        <section class="womens-block">
          <div class="womens-block-header">
            <h2 class="womens-block-title">WOMEN’S</h2>
          ...
          <div class="womens-block-asortment">
            <div class="womens-block-asortment-item">
              <div>
                <img src="./assets/image/women/wear.jpg" alt="asortment-img" class="asortment-img" />
              </div>
            ...
            <div class="womens-block-asortment-item">
              <div>
                <img src="./assets/image/women/wear1.jpg" alt="asortment-img" class="asortment-img" />
              </div>
              <p class="asortment-title">Women's tracksuit Q109</p>
              <div class="asortment-description">
                <p class="asortment-description-price">$ 30.00</p>
            ...
            <div class="womens-block-asortment-item">
              <div>
                <img src="./assets/image/women/wear2.jpg" alt="asortment-img" class="asortment-img" />
              </div>
              <p class="asortment-title">Women's tracksuit Q109</p>
              <div class="asortment-description">
                <p class="asortment-description-price">$ 30.00</p>
            ...
            <div class="womens-block-asortment-item">
              <div>
                <img src="./assets/image/women/wear4.jpg" alt="asortment-img" class="asortment-img" />
              </div>
              <p class="asortment-title">Women's tracksuit Q109</p>
              <div class="asortment-description">
                <p class="asortment-description-price">$ 30.00</p>
            ...
            <div class="womens-block-asortment-item">
              <div>
                <img src="./assets/image/women/wear5.jpg" alt="asortment-img" class="asortment-img" />
              </div>
              <p class="asortment-title">Women's tracksuit Q109</p>
              <div class="asortment-description">
                <p class="asortment-description-price">$ 30.00</p>
            ...
            <div class="womens-block-asortment-item">
              <div>
                <img src="./assets/image/women/wear6.jpg" alt="asortment-img" class="asortment-img" />
              </div>
              <p class="asortment-title">Women's tracksuit Q109</p>
              <div class="asortment-description">
                <p class="asortment-description-price">$ 30.00</p>
            ...
            <div class="womens-block-asortment-item">
              <div>
                <img src="./assets/image/women/wear7.jpg" alt="asortment-img" class="asortment-img" />
              </div>
              <p class="asortment-title">Women's tracksuit Q109</p>
              <div class="asortment-description">
                <p class="asortment-description-price">$ 30.00</p>
            ...
            <div class="womens-block-asortment-item">
              <div>
                <img src="./assets/image/women/wear8.jpg" alt="asortment-img" class="asortment-img" />
              </div>
              <p class="asortment-title">Women's tracksuit Q109</p>
              <div class="asortment-description">
                <p class="asortment-description-price">$ 30.00</p>
          ...
          <h3 class="womens-block-all">See All</h3>
        </section>
        <section class="womens-block">
          <div class="womens-block-header">
