...
import locationFooter from '../../assets/image/footer/icon1.png';
import phoneFooter from '../../assets/image/footer/icon2.png';
import clockFooter from '../../assets/image/footer/icon3.png';
import emailIconFooter from '../../assets/image/footer/icon4.png'
